...
```{r, fig.cap="From http://phdcomics.com/comics/archive.php?comicid=1531", out.extra="class=external", fig.align='center'}
...
```{r basic git table, echo = F, layout="l-body-outset"}
bct <- tibble::tribble(
...
```{r branches git table, layout="l-body-outset"}
brct <- tibble::tribble(
  ~Command, ~Usage, ~Example, 
...
```{r, fig.cap="From https://blog.programster.org/git-workflows", out.extra="class=external", fig.align='center'}

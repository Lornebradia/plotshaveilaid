...
<aside>
Yes, this has happened to me. No, it wasn't pretty
</aside>

* A super modeller, capable of writing in many different languages models for everything in a data science workbook: from classical parametric models to the latest craze in deep learning, 

(continue rant on super skills): 

- Deployment
- Communication
- Belly dancing with data

(point out that this skillset is going to be hard to fit into a single human brain, and human brains are single threaded, so it's better to use a team and parallelise as much as possible). 

Also if you are looking for a single person to do all sorts of stuff you're not looking for a rockstar, you're looking for a one-man orchestra
